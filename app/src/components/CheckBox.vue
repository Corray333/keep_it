        ...
        <div @click="toggleDone"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="12" height="10" viewBox="0 0 12 10" fill="none">
                <path :style="done ? 'stroke-dashoffset: -40;' : 'stroke-dashoffset: -20;'"
                    d="M1 5.5L4.18849 8.28992C4.62644 8.67313 5.29783 8.6029 5.64699 8.13735L11 1" stroke="var(--invert-bg)"
...
.checkbox{
    @apply  cursor-pointer flex justify-center items-center border-2 border-invert-bg rounded-md;
    width: 1.125em;
    height: 1.125em;
}
